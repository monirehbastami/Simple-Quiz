...
var Config = {
   ...
   * <div id="plotId" class="datepicker-plot-area datepicker-plot-area-inline-view">
   ...
   <div class="title"></div>
   <div class="headerr-row">
   <div class="headerr-row-cell">ش</div>
   <div class="headerr-row-cell">ی</div>
   <div class="headerr-row-cell">د</div>
   <div class="headerr-row-cell">س</div>
   <div class="headerr-row-cell">چ</div>
   <div class="headerr-row-cell">پ</div>
   <div class="headerr-row-cell">ج</div>
   </div>
   </div>
   <table cellspacing="0" class="table-days">
   <tbody>
